...
const requestLoan = async (contract, providers, walletContext, rli) => {
    ...
    const coinPubKeyHex = walletContext.shieldedSecretKeys.coinPublicKey;
...
const changePinFlow = async (contract, rli) => {
...
const blacklistUserFlow = async (contract, rli) => {
...
const removeBlacklistUserFlow = async (contract, rli) => {
...
const transferAdminFlow = async (contract, rli) => {
...
const registerProviderFlow = async (contract, rli) => {
...
const removeProviderFlow = async (contract, rli) => {
...
const mainLoop = async (providers, walletContext, rli) => {
...
const buildWalletFromMnemonic = async (config, rli) => {
